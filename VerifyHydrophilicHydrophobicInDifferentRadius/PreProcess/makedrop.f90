...
!	parameters
	...
	parameter (MAXCTP = 10, MAXBDS = 500000, NDIM = 3, MAXDP = 30)
...
!	Locals
	...
	parameter (MAXWATM = 10000000, MAXATOM = 30000000)
    ...
    if (existfile)then
        ...
        read(sph, '(1x, i8, f12.5)') npt, RdsDp0 
    ...
    write(*,*) "RdsDp = ",RdsDp, "RdsDp0 = ",RdsDp0
...
!        endif
   ...
   !pause
    ...
    integer i, j, k, ii, jj, n, m1, m2, ni,ntemp
    parameter (pi=3.1415926536)
...
!       m2 = int(rnp(i)/m1)
    ...
    !write(211, '(1x, i8, f12.5)') n - ni + 1, rdp
    write(211, '(1x, i8, f12.5)') n , rdp
    ni = 1
    do i = ni, n
...
!    call getCPUtime(t1)
   ...
   ! write (123,*) PI
    ...
    open(555, file='./data/sphere/test.txt')
    do while(.true.)
       F=0
       do i=1,m
          do j=1,n
